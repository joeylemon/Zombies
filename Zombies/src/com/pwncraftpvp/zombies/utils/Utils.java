...
public class Utils {
	...
	public static final void spawnDog(Location loc){
		...
		wolf.setMaxHealth(main.game.getDogHealth());
		wolf.setHealth(main.game.getDogHealth());
	...
	/**
	 * Get the next dog spawn id for an area
	 * @param map - The map
	 * @param area - The area id
	 * @return The next dog spawn id
	 */
	public static final int getNextDogSpawnID(Map map, int area){
		int id = 1;
		Area a = map.getArea(area);
		if(a != null){
