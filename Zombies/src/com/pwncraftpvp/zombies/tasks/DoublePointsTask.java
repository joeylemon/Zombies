...
public class DoublePointsTask extends BukkitRunnable {
	...
	public void cancelTask(){
		Utils.broadcastMessage("The current " + ChatColor.RED + "Double Points " + ChatColor.GRAY + "has run out.");
		main.game.doublepointstask = null;
		this.cancel();
	}
